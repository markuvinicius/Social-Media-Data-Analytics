...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 28 22:10:17 2017
...
# Parse the command
    parser = argparse.ArgumentParser(description='Twitter Streaming Search')
...
myStream.filter(track=['greve'])

myStream.filter(track=['Greve'], async=True)
