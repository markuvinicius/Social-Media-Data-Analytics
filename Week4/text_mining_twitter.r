# Carregando as bibliotecas necess??rias para o processamento 
library(tm)
library(igraph)
...
# remove o caracter 'b' do come??o da string
...
control = list(removePunctuation = TRUE,
                ...
                stopwords = c("and", "of", "for", "in", "a", "is", "the", "as", "to", "are", "have","with","you","if","was","by","could","this","over","has","that","us","an"))
